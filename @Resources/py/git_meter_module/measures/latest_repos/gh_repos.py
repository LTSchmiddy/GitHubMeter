...
from git_meter_module.monitor.repo_monitors.gh_repo_list import GHUserReposMonitor

class GHLatestReposMeasure(LatestReposMeasureBaseType(GHUserReposMonitor)):
    def GetString(self):
        return f"Latest Repos for {GHUserReposMonitor.get_instance().login_name} on GitHub"
